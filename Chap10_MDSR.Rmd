...
```{r}
# p. 222
NCI60 <- read.csv("C:/Users/a5730/Downloads/NCI60.csv", header = T, sep = "," )
...
geom_line(data = filter(Sim_spreads, order <= 500), 
          color = "red", 
          size = 2)
...
while (any_active(df)) 
  ...
  now <- ifelse(next_one$arrival >= endtime, 
                next_one$arrival, 
                endtime)
